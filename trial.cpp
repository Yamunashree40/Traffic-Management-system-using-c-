...
int SmartTrafficManagementSystem::welcome()
{
        system("cls");
        time_t tt;
        time (&tt); //to get the address of the  current time from the system
        cout<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<"                                                     " <<asctime(localtime(&tt));
        delay1();
        system("cls");
        cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
        cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
...
int SmartTrafficManagementSystem::recOfVeh()
{
        cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
        cout<<"*                                                            WELCOME TO                                                               *"<<endl;
...
int SmartTrafficManagementSystem::display1()
{
        system("cls");
...
int SmartTrafficManagementSystem::recOfVeh_1()
{
        ...
        cout<<"Enter a single record"<<endl;
...
int SmartTrafficManagementSystem::recOfVeh_2()
{
        system("cls");
        string path = "RecordOfVehicles.txt";
        ifstream file(path);
...
int SmartTrafficManagementSystem::recOfVeh_3()
{
    system("cls");
...
int SmartTrafficManagementSystem::recOfChall()
{
    cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
        cout<<"*                                                            WELCOME TO                                                               *"<<endl;
...
int SmartTrafficManagementSystem::display()
{
    system("cls");
...
int SmartTrafficManagementSystem::recOfChall_1()
{
        system("cls");
        fstream fio;
        string line;
...
int SmartTrafficManagementSystem::recOfChall_2()
{
        system("cls");
        string path = "RecordOfChallan.txt";
        ifstream file(path);
...
int SmartTrafficManagementSystem::recOfChall_3()
{
        system("cls");
        string path = "RecordOfChallan.txt";
        ifstream file(path);
...
int SmartTrafficManagementSystem::trafContBooth()
{
...
int SmartTrafficManagementSystem::trafContBooth_1()
{
        system("cls");
        for (int i = 0; i < 50; ++i)
        {
...
int SmartTrafficManagementSystem::trafContBooth_2()
{
        system("cls");
        for (int i = 0; i < 50; ++i)
        {
...
int SmartTrafficManagementSystem::trafContBooth_3()
{
        system("cls");
        for (int i = 0; i < 50; ++i)
            {
...
int SmartTrafficManagementSystem:: helpInfo()
{
...
int SmartTrafficManagementSystem::vehSearch()
    {
        cout<<">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
        cout<<"*                                                            WELCOME TO                                                               *"<<endl;
